<!DOCTYPE html>
<html lang="en"><title>MAHAVINAYAK ROADLINES</title>
  <!-- Add Bootstrap Links -->
...
<nav class="w3-sidebar w3-green w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <a href="#"  >&nbsp;</a>
    <a href="#showcase" onclick="window.location.href='dbc.php'" class="w3-hover-white">Add Accounts</a>
    <a href="#services" onclick="window.location.href='editnew.php'" class="w3-hover-white">Edit Accounts</a>
    ...
    <a href="#contact" onclick="window.location.href='addv.html'" class="w3-hover-white">Add Vehicle name</a>
